...
defaultproperties
{
	bodyparts(0)=LodMesh'SkaarjTail'
	bodyparts(1)=LodMesh'SkaarjBody'
	bodyparts(2)=LodMesh'SkaarjHand'
	bodyparts(3)=LodMesh'SkaarjBody'
	bodyparts(4)=LodMesh'SkaarjLeg'
	bodyparts(5)=LodMesh'SkaarjLeg'
	bodyparts(6)=LodMesh'CowBody1'
	bodyparts(7)=LodMesh'SkaarjHead'
	ZOffset(1)=0.000000
	ZOffset(3)=0.300000
	ZOffset(4)=-0.500000
	ZOffset(5)=-0.500000
	AnimSequence="Death"
	Mesh=LodMesh'Skaarjw'
