...
defaultproperties
{
	Fragments(0)=LodMesh'vfrag1'
	Fragments(1)=LodMesh'vfrag2'
	Fragments(2)=LodMesh'vfrag3'
	Fragments(3)=LodMesh'vfrag4'
	Fragments(4)=LodMesh'vfrag5'
	Fragments(5)=LodMesh'vfrag6'
	Fragments(6)=LodMesh'vfrag7'
	numFragmentTypes=7
