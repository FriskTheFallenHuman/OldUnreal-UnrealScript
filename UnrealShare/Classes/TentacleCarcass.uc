...
defaultproperties
{
	bodyparts(0)=LodMesh'TentBody'
	bodyparts(1)=LodMesh'TentPart'
	bodyparts(2)=LodMesh'TentPart'
	bodyparts(3)=LodMesh'TentArm'
	bodyparts(4)=LodMesh'TentArm'
	bodyparts(5)=LodMesh'TentHead'
	bodyparts(6)=LodMesh'TentArm'
	AnimSequence="Dead1Land"
	Mesh=LodMesh'Tentacle1'
