...
defaultproperties
{
	...
	PlayerViewMesh=LodMesh'StingerM'
	PlayerViewScale=1.700000
	PickupViewMesh=LodMesh'StingerPickup'
	ThirdPersonMesh=LodMesh'Stinger3rd'
	PickupSound=Sound'UnrealShare.Pickups.WeaponPickup'
	Mesh=LodMesh'StingerPickup'
	bNoSmooth=False
	SoundRadius=64
	SoundVolume=255
