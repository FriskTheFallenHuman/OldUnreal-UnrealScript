...
defaultproperties
{
	bodyparts(0)=LodMesh'SlithPart'
	bodyparts(1)=LodMesh'SlithPart'
	bodyparts(2)=LodMesh'SlithHand'
	bodyparts(3)=LodMesh'SlithHead'
	bodyparts(4)=LodMesh'SlithArm'
	bodyparts(5)=LodMesh'SlithArm'
	bodyparts(6)=LodMesh'CowBody1'
	bodyparts(7)=LodMesh'SlithTail'
	ZOffset(0)=0.000000
	ZOffset(1)=0.000000
	AnimSequence="Dead1"
	Mesh=LodMesh'Slith1'
