...
defaultproperties
{
	Fragments(0)=LodMesh'wfrag1'
	Fragments(1)=LodMesh'wfrag2'
	Fragments(2)=LodMesh'wfrag3'
	Fragments(3)=LodMesh'wfrag4'
	Fragments(4)=LodMesh'wfrag5'
	Fragments(5)=LodMesh'wfrag6'
	Fragments(6)=LodMesh'wfrag7'
	Fragments(7)=LodMesh'wfrag8'
	Fragments(8)=LodMesh'wfrag9'
	numFragmentTypes=9
