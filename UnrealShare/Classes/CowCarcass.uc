...
defaultproperties
{
	bodyparts(0)=LodMesh'CowHead'
	bodyparts(1)=LodMesh'CowBody2'
	bodyparts(2)=LodMesh'CowBody1'
	bodyparts(3)=LodMesh'CowLeg'
	bodyparts(4)=LodMesh'CowTail'
	bodyparts(5)=LodMesh'CowFoot'
	LandedSound=Sound'UnrealShare.Cow.thumpC'
	Mesh=LodMesh'NaliCow'
