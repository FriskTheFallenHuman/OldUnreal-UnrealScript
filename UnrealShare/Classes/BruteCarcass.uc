...
defaultproperties
{
	bodyparts(0)=LodMesh'BruteHead'
	bodyparts(1)=LodMesh'BruteFoot'
	bodyparts(2)=LodMesh'BruteHand'
	bodyparts(3)=LodMesh'BigChunk1'
	bodyparts(4)=LodMesh'BrutePiece'
	bodyparts(5)=LodMesh'BrutePiece'
	bodyparts(6)=LodMesh'BruteHand'
	bodyparts(7)=LodMesh'bigchunk2'
	ZOffset(0)=0.600000
	ZOffset(1)=0.500000
	ZOffset(3)=0.200000
	ZOffset(4)=-0.200000
