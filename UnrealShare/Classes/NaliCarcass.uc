...
defaultproperties
{
	bodyparts(0)=LodMesh'NaliPart'
	bodyparts(1)=LodMesh'NaliLeg'
	bodyparts(2)=LodMesh'NaliPart'
	bodyparts(3)=LodMesh'NaliFoot'
	bodyparts(4)=LodMesh'NaliHand1'
	bodyparts(5)=LodMesh'NaliHand2'
	bodyparts(6)=LodMesh'NaliHead'
	ZOffset(0)=0.000000
	ZOffset(3)=-0.500000
	ZOffset(6)=0.500000
