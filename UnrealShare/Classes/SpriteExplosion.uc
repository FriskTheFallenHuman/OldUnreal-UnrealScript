...
defaultproperties
{
	s_Exp(1)=Texture's_Exp001'
	s_Exp(2)=Texture's_Exp002'
	s_Exp(3)=Texture's_Exp003'
	s_Exp(4)=Texture's_Exp004'
	s_Exp(5)=Texture's_Exp005'
	s_Exp(6)=Texture's_Exp006'
	s_Exp(7)=Texture's_Exp007'
	s_Exp(8)=Texture's_Exp008'
	s_Exp(9)=Texture's_Exp009'
	s_Exp(10)=Texture's_Exp010'
	s_Exp(11)=Texture's_Exp011'
	s_Exp(12)=Texture's_Exp012'
	s_Exp(13)=Texture's_Exp013'
	s_Exp(14)=Texture's_Exp014'
	s_Exp(15)=Texture's_Exp015'
	s_Exp(16)=Texture's_Exp016'
	s_Exp(17)=Texture's_Exp017'
	s_Exp(18)=Texture's_Exp018'
	s_Exp(19)=Texture's_Exp019'
	RemoteRole=ROLE_SimulatedProxy
	DrawType=DT_Sprite
	Texture=Texture's_Exp001'
	AmbientGlow=160
}
