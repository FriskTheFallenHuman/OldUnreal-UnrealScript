...
defaultproperties
{
	...
	GameCommandLine="-log"
	EditPackages=("Core","Engine","Editor","UWindow","Fire","IpDrv","UWeb","UBrowser","UnrealShare","UnrealI","UMenu","Botpack","IpServer","UTServerAdmin","UTMenu","UTBrowser","EpicCustomModels","MultiMesh","Relics","udemo","JazzSpecial")
	...
	C_ActorWire=(R=127,G=63,A=255)
	C_ActorHiWire=(R=255,G=127,A=255)
	C_Black=(A=255)
	C_White=(R=255,G=255,B=255,A=255)
	C_Mask=(A=255)
	C_SemiSolidWire=(R=127,G=255,A=255)
