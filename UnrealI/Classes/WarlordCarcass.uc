...
defaultproperties
{
	bodyparts(0)=LodMesh'WarlordWing'
	bodyparts(1)=LodMesh'WarlordHead'
	bodyparts(2)=LodMesh'WarlordLeg'
	bodyparts(3)=LodMesh'WarlordArm'
	bodyparts(4)=LodMesh'WarlordLeg'
	bodyparts(5)=LodMesh'WarlordGun'
	bodyparts(6)=LodMesh'WarlordFoot'
	bodyparts(7)=LodMesh'WarlordHand'
	ZOffset(1)=0.500000
	ZOffset(2)=-0.500000
	ZOffset(4)=-0.500000
	ZOffset(6)=-0.700000
