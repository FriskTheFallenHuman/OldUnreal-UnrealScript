...
defaultproperties
{
	bodyparts(0)=LodMesh'GasHead'
	bodyparts(1)=LodMesh'GasArm1'
	bodyparts(2)=LodMesh'GasArm2'
	bodyparts(3)=LodMesh'GasHand'
	bodyparts(4)=LodMesh'GasPart'
	bodyparts(5)=LodMesh'GasPart'
	ZOffset(0)=0.700000
	ZOffset(1)=0.000000
	ZOffset(2)=0.350000
	ZOffset(3)=-0.300000
