...
defaultproperties
{
	AmmoName=Class'FlakBox'
	PickupAmmoCount=20
	AutoSwitchPriority=2
	InventoryGroup=3
	PickupMessage="You got the QuadShot"
	PlayerViewOffset=(X=5.000000,Y=-1.000000,Z=-3.000000)
	PlayerViewMesh=LodMesh'QuadShotHeld'
	PlayerViewScale=1.590000
	PickupViewMesh=LodMesh'QuadShotPickup'
	ThirdPersonMesh=LodMesh'Flak3rd'
	PickupSound=Sound'UnrealShare.Pickups.WeaponPickup'
	Mesh=LodMesh'QuadShotPickup'
	bNoSmooth=False
	Mass=10.000000
}
