...
defaultproperties
{
	bodyparts(0)=LodMesh'MercLeg'
	bodyparts(1)=LodMesh'MercPart'
	bodyparts(2)=LodMesh'MercGun'
	bodyparts(3)=LodMesh'MercPart'
	bodyparts(4)=LodMesh'MercLeg'
	bodyparts(5)=LodMesh'MercHead'
	ZOffset(1)=0.000000
	ZOffset(4)=-0.500000
	ZOffset(5)=-0.500000
	bGreenBlood=True
