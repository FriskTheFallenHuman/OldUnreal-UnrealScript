...
defaultproperties
{
	bodyparts(0)=LodMesh'SquidBody'
	bodyparts(1)=LodMesh'SquidPart'
	bodyparts(2)=LodMesh'SquidPart'
	bodyparts(3)=LodMesh'SquidTail'
	bodyparts(4)=LodMesh'SquidTail2'
	bodyparts(5)=LodMesh'SquidTail3'
	bodyparts(6)=LodMesh'SquidTail4'
	bodyparts(7)=LodMesh'SquidTail5'
	AnimSequence="Dead1"
	Mesh=LodMesh'Squid1'
