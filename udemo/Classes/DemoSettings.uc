...
defaultproperties
{
	bOneTimeUpgrade=True
	FollowMyCam=True
	timing=1
	OrderByDate=True
	DemoPaths(0)="E:\\Games\\UnrealTournament\\System\\"
	DemoPaths(1)="Empty"
	DemoPaths(2)="Empty"
	DemoPaths(3)="Empty"
	DemoPaths(4)="Empty"
	...
	RedirectServers(1)="(Empty)"
	RedirectServers(2)="(Empty)"
	RedirectServers(3)="(Empty)"
	RedirectServers(4)="(Empty)"
	RedirectServers(5)="(Empty)"
